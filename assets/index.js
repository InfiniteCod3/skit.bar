...
async function vid() {
    if (Math.random() < 0.5) {
        document.getElementById("bgVid").src = "assets/vid2.mp4";
        currentVid = 2;
    } else {
        document.getElementById("bgVid").src = "assets/vid4.mp4";
        currentVid = 4;
    }
...
async function run() {
    if (!ran) {
        ran = true;
        document.getElementById("bodyDiv").style.webkitFilter = "blur(0px)";
        ...
        while (opacity >= 0) {
            ...
            document.getElementById("runner").style.opacity = opacity + "";
        }
